...
import org.apache.beam.vendor.calcite.v1_41_0.org.apache.calcite.DataContext;
import org.apache.beam.vendor.calcite.v1_41_0.org.apache.calcite.adapter.enumerable.JavaRowFormat;
import org.apache.beam.vendor.calcite.v1_41_0.org.apache.calcite.adapter.enumerable.PhysType;
import org.apache.beam.vendor.calcite.v1_41_0.org.apache.calcite.adapter.enumerable.PhysTypeImpl;
import org.apache.beam.vendor.calcite.v1_41_0.org.apache.calcite.adapter.enumerable.RexToLixTranslator;
import org.apache.beam.vendor.calcite.v1_41_0.org.apache.calcite.adapter.java.JavaTypeFactory;
import org.apache.beam.vendor.calcite.v1_41_0.org.apache.calcite.avatica.util.ByteString;
import org.apache.beam.vendor.calcite.v1_41_0.org.apache.calcite.linq4j.QueryProvider;
import org.apache.beam.vendor.calcite.v1_41_0.org.apache.calcite.linq4j.tree.BlockBuilder;
import org.apache.beam.vendor.calcite.v1_41_0.org.apache.calcite.linq4j.tree.Expression;
import org.apache.beam.vendor.calcite.v1_41_0.org.apache.calcite.linq4j.tree.Expressions;
import org.apache.beam.vendor.calcite.v1_41_0.org.apache.calcite.linq4j.tree.MemberDeclaration;
import org.apache.beam.vendor.calcite.v1_41_0.org.apache.calcite.linq4j.tree.ParameterExpression;
import org.apache.beam.vendor.calcite.v1_41_0.org.apache.calcite.linq4j.tree.Types;
import org.apache.beam.vendor.calcite.v1_41_0.org.apache.calcite.plan.RelOptCluster;
import org.apache.beam.vendor.calcite.v1_41_0.org.apache.calcite.plan.RelOptPredicateList;
...
import org.apache.beam.vendor.calcite.v1_41_0.org.apache.calcite.rel.core.Calc;
import org.apache.beam.vendor.calcite.v1_41_0.org.apache.calcite.rel.metadata.RelMetadataQuery;
import org.apache.beam.vendor.calcite.v1_41_0.org.apache.calcite.rex.RexBuilder;
import org.apache.beam.vendor.calcite.v1_41_0.org.apache.calcite.rex.RexCall;
import org.apache.beam.vendor.calcite.v1_41_0.org.apache.calcite.rex.RexNode;
import org.apache.beam.vendor.calcite.v1_41_0.org.apache.calcite.rex.RexProgram;
import org.apache.beam.vendor.calcite.v1_41_0.org.apache.calcite.rex.RexSimplify;
import org.apache.beam.vendor.calcite.v1_41_0.org.apache.calcite.rex.RexUtil;
import org.apache.beam.vendor.calcite.v1_41_0.org.apache.calcite.runtime.SqlFunctions;
import org.apache.beam.vendor.calcite.v1_41_0.org.apache.calcite.schema.Function;
import org.apache.beam.vendor.calcite.v1_41_0.org.apache.calcite.schema.SchemaPlus;
import org.apache.beam.vendor.calcite.v1_41_0.org.apache.calcite.sql.SqlOperator;
import org.apache.beam.vendor.calcite.v1_41_0.org.apache.calcite.sql.validate.SqlConformance;
import org.apache.beam.vendor.calcite.v1_41_0.org.apache.calcite.sql.validate.SqlConformanceEnum;
import org.apache.beam.vendor.calcite.v1_41_0.org.apache.calcite.sql.validate.SqlUserDefinedFunction;
