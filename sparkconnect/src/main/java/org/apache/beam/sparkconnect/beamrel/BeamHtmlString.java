...
import org.apache.beam.sparkconnect.ptransform.HtmlStringPTransform;
...
public class BeamHtmlString extends SingleRel implements BeamRelNode {

  private final int numRows;
  private final int truncate;

  public BeamHtmlString(
    ...
    return new PTransform<PCollectionList<Row>, PCollection<Row>>() {
      ...
      public PCollection<Row> expand(PCollectionList<Row> pinput) {
        checkArgument(
            ...
            BeamHtmlString.class.getSimpleName(),
            pinput);
        PCollection<Row> upstream = pinput.get(0);

        return upstream.apply(new HtmlStringPTransform(numRows, truncate));
      }
    };
  }
  ...
  @Override
  public final BeamHtmlString copy(RelTraitSet traitSet, List<RelNode> inputs) {
    return new BeamHtmlString(getCluster(), traitSet, sole(inputs), numRows, truncate);
  }
}
