...
/** A custom {@code RelNode} to represent the Spark {@code htmlString} operation. */
public class LogicalHtmlString extends SingleRel {

  public final int numRows;
  public final int truncate;

  public LogicalHtmlString(
  ...
  public RelNode copy(RelTraitSet traitSet, List<RelNode> inputs) {
    return new LogicalHtmlString(getCluster(), traitSet, sole(inputs), numRows, truncate);
  }
}
